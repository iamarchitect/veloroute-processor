...
/**
 * Example: SelectionQueryBuilder q = new SelectionQueryBuilder()
 * .expr("is_awesome", EQ, true) .expr("money", GT, 50.0f) .expr("speed", LT,
 * 21.1f) .expr("door_number", EQ, 123) .opt("apples", EQ, 0);
 * 
 */
